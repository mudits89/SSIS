...
using System.Web.UI.WebControls;
    ...
    public partial class departmentrep_cart : System.Web.UI.Page
    {
        ...
        protected string setEmailBody()
        {
            ...
            body += "<p>The stationery items requested by " + userId + "</p><br><br><table width='100%' style='border:Solid 1px Black;'>" +
               "<th>" + "<td>ItemName</th>" + "<th>Requested Quantity</th>" + "<th>Price</th>";
