<%@ Page Language="C#" MasterPageFile="~/MasterPage_Employee.Master" AutoEventWireup="true" CodeFile="RequestStationery.aspx.cs" Inherits="RequestStationery" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" >                          
                            <asp:LinkButton ID="LinkButton1" runat="server" 
                                ...
                                CssClass="btn btn-primary"> <span aria-hidden="true" class="glyphicon glyphicon-shopping-cart"></span>&nbsp;View Cart  <asp:Label ID="LblCount" style="background:#ff0000; color:#fff; padding:0 0 0 0; vertical-align:top;" runat="server" CssClass="badge badge-warning"  ForeColor="Black" Text="0"/></asp:LinkButton></div></div><br />
                    <br />
                    <div class="row">
                        <div class="col-md-2">                            
                            <asp:Label ID="LblStioneryItem" runat="server" Text="Stationery Items:" Font-Size="Small" Font-Bold="true" CssClass="label-t3" Visible="False"></asp:Label></div><div class="col-md-1 visible-md visible-lg" style="width:18px;padding:0;"></div>
                        <div class="col-md-9">
                                    ...
                                    <asp:GridView ID="GridStationery" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Quantity">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="Quantity" CssClass="form-control input-lg"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="Quantity" runat="server" CssClass="validator-t3"
                                                        ErrorMessage="Only numbers allowed" ValidationExpression="^[0-9]*$" SetFocusOnError="True"></asp:RegularExpressionValidator></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Add">
                                                <ItemTemplate>
                                                ...
                                                <span aria-hidden="true" class="glyphicon glyphicon-plus-sign" title="Add" ></span>
                                                    </asp:LinkButton></ItemTemplate></asp:TemplateField></Columns></asp:GridView></ContentTemplate></asp:UpdatePanel></div></div></div><br />
            </div>
        </div>
    </div>
