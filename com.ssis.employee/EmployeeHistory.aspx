<%@ Page Language="C#" MasterPageFile="~/MasterPage_Employee.Master" AutoEventWireup="true" CodeFile="EmployeeHistory.aspx.cs" Inherits="EmployeeHistory" %>
            ...
            <div class="panel panel-t3">
                ...
                <div class="panel-body-t3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="searchtxt" runat="server" AutoPostBack="true"  CssClass="form-control input-lg" OnSelectedIndexChanged="Button_click" OnTextChanged="Button_click">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="GridView2" runat="server" DataKeyNames="Requisition_ID" DataSourceID="SqlDataSource1"
                                        ...
                                        <Columns>
                                            ...
                                            <HeaderStyle CssClass="visible-md visible-lg" />
                                            <ItemStyle CssClass="visible-md visible-lg" />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField ShowHeader="False"  HeaderText="Cancel order">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text="Cancel Order"
                                                 Visible='<%# Eval("Status").ToString().Equals("Pending") %>'
                                                        OnClientClick="return confirm('Do you want to cancel the order?');" CssClass="btn btn-link">
                    ...
                    <div>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SSISConnectionString %>" 
                            SelectCommand="SELECT * FROM [Stationery_Requisition] WHERE ([User_ID] = @User_ID)" DeleteCommand="DELETE FROM [Stationery_Requisition] WHERE ([Requisition_ID]= @Requisition_ID);DELETE FROM [Requisition_Items] WHERE ([Requisition_ID]= @Requisition_ID);">
                            <DeleteParameters>
