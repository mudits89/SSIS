...
public partial class Store_ViewInvoice : System.Web.UI.Page
{
...
protected void Button1_Click(object sender, EventArgs e)
{
    ...
    Response.Redirect("Store_ChangePurchaseOrderDetails.aspx?order_id=" + orderid + "&Order_Date=" + d);
