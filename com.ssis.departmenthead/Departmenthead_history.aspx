<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_DeptHd.Master" AutoEventWireup="true" CodeFile="Departmenthead_history.aspx.cs" Inherits="Departmenthead_history" %>
                ...
                <div class="panel-heading-t3">
                    <div class="row">
                        <div class="col-md-12" style="text-align: left; padding-top: 2%; padding-left: 3%;">
                            <asp:Label ID="Label1" runat="server" Text="Department History" CssClass="page-header"></asp:Label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="panel-body-t3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11" style="padding:0;margin:0;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                                <ContentTemplate>
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="EntityDataSource1" CssClass="table table-striped table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField ItemStyle-Width="20%" DataField="Requisition_Date" HeaderText="Submitted Date" ReadOnly="True" SortExpression="Requisition_Date" DataFormatString="{0:dd-MMMMM-yyyy}" />
                                            <asp:BoundField ItemStyle-Width="20%" DataField="Name" HeaderText="Submitted by" ReadOnly="True" SortExpression="Name" />
                                            <asp:BoundField ItemStyle-Width="20%" DataField="Reason" HeaderText="Reason" ReadOnly="True" SortExpression="Reason" 
                                                HeaderStyle-CssClass="visible-md visible-lg" ItemStyle-CssClass="visible-md visible-lg"/>
                                            <asp:BoundField ItemStyle-Width="20%" DataField="Status" HeaderText="Status" ReadOnly="True" SortExpression="Status" 
                                                HeaderStyle-CssClass="visible-md visible-lg" ItemStyle-CssClass="visible-md visible-lg" />
                    ...
                    <div>
                        <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=SSISEntities"
                            ...
                            Select="it.[Requisition_ID], it.[Employee].[Name], it.[Requisition_Date], it.[Status], it.[Reason]"
