<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_DeptHd.Master" AutoEventWireup="true" CodeFile="PendingRequisitionDetails.aspx.cs" Inherits="PendingRequisitionDetails" %>
                ...
                <div class="panel-footer-t3">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="position: static;">
                            <asp:Button ID="btnApprove" runat="server" Text="Approve" Width="150px"
                                OnClick="btnApprove_Click" OnClientClick="return confirm('Are you sure you want to proceed?')" CssClass="btn btn-primary" />
                            &nbsp;
                            <asp:Button ID="btnReject" runat="server" Text="Reject" Width="150px"
                                OnClick="btnReject_Click" OnClientClick="return confirm('Are you sure you want to proceed?')" CssClass="btn btn-outline" />
                        </div>
                    </div>
