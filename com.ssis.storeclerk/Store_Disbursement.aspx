<%@ Page Title="" Language="C#" MasterPageFile="~/StoreClerk_MasterPage.master" AutoEventWireup="true" CodeFile="Store_Disbursement.aspx.cs" Inherits="Store_Disbursement" %>
                ...
                <div class="panel-heading-t3">
                    <div class="row">
                        <div class="col-md-12" style="text-align:left">
                             <asp:Label ID="txtName" runat="server"  Text="Department List" CssClass="page-header"></asp:Label>    
                        </div>
                   ...
                   <div class="panel-body-t3">
                       ...
                       <asp:Label ID="Label4" CssClass="label-t3" runat="server" Font-Size="Large"></asp:Label>
                       <div class="row">
                            <div class="col-md-12" style="text-align:left">
                                 <asp:RadioButtonList ID="RadioButtonList1" runat="server"  CssClass="radio-btn"  DataSourceID="EntityDataSource1" AutoPostBack="true"  DataTextField="Department_Name" DataValueField="Department_ID" CellPadding="6"  RepeatLayout="Table"
                                      RepeatColumns = "5" 
                                      RepeatDirection="Vertical" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                                 </asp:RadioButtonList>
                                 <hr />
                                <br />
                               
                                 <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=SSISEntities" DefaultContainerName="SSISEntities" EnableFlattening="False" EntitySetName="Departments" Select="it.[Department_Name], it.[Department_ID]">
              ...
              <div class="panel-body-t3">
                      <div class="row">
                            <div class="col-md-2">
                             ...
                             <div class="col-md-2">
                                  <asp:Label ID="Label2" CssClass="label-t3" runat="server" Text="Label"></asp:Label>
                            </div>
                          <br />   <br />
                        </div>
                   <div class="row">
                             <div class="col-md-12">
                                 <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="false" CssClass="table table-striped table-hover" EmptyDataText="No Record Found" Width="100%" BorderWidth="0px" GridLines="Horizontal" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                                     <Columns>
                                        <asp:TemplateField HeaderText="Department OrdID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepOrdId" runat="server" Text='<%#Eval("Department_Orders_ID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField  HeaderText="ItemId" Visible="false">
                                          ...
                                          <asp:TemplateField HeaderText="Requisition_Date" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRequestion" runat="server" Text='<%#Eval("Requisition_Date") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField  HeaderText="Requested Quantity ">
                                            <ItemTemplate>
                                                <asp:Label ID="lblrQty" runat="server" Text='<%#Eval("Requisition_Quantity") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Issuing Quantity">
                                            <ItemTemplate>
                                                <asp:Label ID="lblfQty" runat="server" Text='<%#Eval("Fulfilled_Quantity") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                             ...
                             <div class="row" style="text-align:right;">  
                                   <div class="col-md-9"> 
                                        <asp:Label ID="lblsign" runat="server" Text="Signature :"   CssClass="label-t3" ></asp:Label>
                                            <asp:Image ID="imgCover" runat="server"  Height="65px" BorderWidth="1px"  BorderStyle="Dotted" ImageUrl="~/Signature/Default.png"/>            
                                   </div>
