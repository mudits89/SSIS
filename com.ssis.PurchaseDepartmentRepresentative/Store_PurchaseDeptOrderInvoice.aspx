<%@ Page Language="C#" MasterPageFile="~/MasterPage_PurchaseDept.Master" AutoEventWireup="true" codefile="Store_PurchaseDeptOrderInvoice.aspx.cs" Inherits="Store_PurchaseDeptOrderInvoice" %>
                        ...
                        <div class="row" >
                            <div class="col-md-8" style="text-align:Left">
                                ...
                                <div class="col-md-2"  style="text-align:right; padding: 0px;">
                                     <asp:Button ID="btnSendInvoice" runat="server" Text="Make Purchase" OnClick="btnSendInvoice_Click"  Width="150px"
                                      CssClass="btn btn-primary" OnClientClick="return confirm('Do you want to proceed with your purchase?');" />
                                       <hr />
                                 </div>
                                <div class="col-md-2" style="padding: 0px;">
                                    <asp:Button ID="Button1" runat="server" Width="150px"
                                    CssClass="btn btn-outline" OnClick="Button1_Click" Text="Back" />
                                    <br />
                                    <hr />
                                </div>
                            </div>
